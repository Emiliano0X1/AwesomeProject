...
const MilkTea = ({navigation,route}) => {
    ...
    const milkTea = extrasMain.filter(extra => extra.type === "LecheTea");
    ...
    const [checked, setChecked] = useState('');
      ...
      const añadirExtra = () => {
        const milkCheked = milkTea.find(milk => milk.value === checked);
        return milkCheked;
      };
        ...
        return(
            <SafeAreaView style = {styles.container}>
                <ScrollView>
                    ...
                    <Text style = {styles.title}> Desea Agregar Leche al producto seleccionado : </Text>
